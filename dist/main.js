...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,sBAAsB;AAC1B;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,sBAAsB;IACtB,iBAAiB;IACjB,uBAAuB;AAC3B","sourcesContent":[":root {\n    box-sizing: border-box;\n}\n\n#content {\n    height: 100%;\n    display: flex;\n    flex-direction: column;\n    max-width: 1200px;\n    border: 1px solid black;\n}"],"sourceRoot":""}]);
// Exports
...
const initPage = () => {
    ...
    heroDiv.id = 'hero';
    heroImg.src = _assets_cafe_jpg__WEBPACK_IMPORTED_MODULE_0__;
...
module.exports = __webpack_require__.p + "4a798fa85ef9c216977b.jpg";
...
/* harmony import */ var _init_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./init-page */ "./src/init-page.js");
...
const TabDisplay = () => {
    const homePage = (0,_init_page__WEBPACK_IMPORTED_MODULE_1__["default"])();
    ...
    const showHomePage = () => {
        clearContents();
        content.appendChild(_init_page__WEBPACK_IMPORTED_MODULE_1__["default"]);
    }
